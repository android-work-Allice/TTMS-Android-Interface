...
<div class="login" style="margin-top:50px;">
    ...
    <div class="header">
        <div class="switch" id="switch"><a class="switch_btn_focus" id="switch_qlogin" href="javascript:void(0);"
                                           tabindex="7">售票员登录</a>
            <a class="switch_btn" id="switch_login" href="javascript:void(0);" tabindex="8">系统管理员登录</a>
        ...
        <div class="web_login" id="web_login">
            <div class="login-box">
                <div class="login_form">
                    <form action="/ttms_ssm/user/login" name="loginform" accept-charset="utf-8" id="login_form"
    ...
    <div class="qlogin" id="qlogin" style="display: none; ">
        ...
        <div class="web_login">
            <form name="form2"  action="/ttms_ssm/user/login" id="regUser" accept-charset="utf-8"  method="post">
